...
public class TraineeRegisterManager {
	...
	public static void totalSelectManager() throws SQLException {
		...
		studentList = TraineeDAO.studentSelect();
		if(studentList == null) {
	...
	public static void insertManager() throws SQLException {
		...
		TraineeVO studentVO = new TraineeVO();
		boolean successFlag = TraineeDAO.studentInsert(studentVO);
	...
	public static void updateManager() throws SQLException {
		...
		TraineeVO svo = new TraineeVO();
		boolean successFlag = TraineeDAO.studentInsert(svo);
	...
	public static void deleteManager() throws SQLException {
		...
		TraineeVO svo = new TraineeVO();
		svo.setNo(no);
		boolean successFlag = TraineeDAO.studentDelete(svo);
	...
	public static void sortManager() throws SQLException {
		ArrayList<TraineeVO> studentList = null;
		studentList = TraineeDAO.studentSort();
		printStudentList(studentList);
	}
	
	// 전체 학생리스트 출력진행
	private static void printStudentList(ArrayList<TraineeVO> studentList) {
		System.out.println("==============================================");
		for (TraineeVO sv : studentList) {
